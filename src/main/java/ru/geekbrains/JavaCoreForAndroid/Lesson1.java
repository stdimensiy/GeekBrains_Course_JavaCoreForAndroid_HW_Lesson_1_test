...
public class Lesson1 {
    public static void main(String[] args) {
        ...
        System.out.println("\nПункт №5 Домашнего задания выполнен! Метод, выводящий в консоль сообщение, является ли аргумент положительным или отрицательным числом, создан.");
        System.out.println("Проверка работоспособности метода 'sendMyIsPositiveOrNegativeNumber':");
        System.out.println("----- значение передаваемых параметров: а=-5. Метод в точку вызова значений не возвращает, вызывается отдельно");
        sendMyIsPositiveOrNegativeNumber(-5);
        System.out.println("----- значение передаваемых параметров: а=15. Метод в точку вызова значений не возвращает, вызывается отдельно");
        sendMyIsPositiveOrNegativeNumber(15);

        // Задание №6 "Написать метод, которому в качестве параметра передается целое число.
        // Метод должен ВЕРНУТЬ true, если число отрицательное, и вернуть false если положительное.
        System.out.println("\nПункт №6 Домашнего задания выполнен! Метод, определяющий какой аргумент, положительный или отрицательный, создан.");
        System.out.println("Проверка работоспособности метода 'isNegative':");
        System.out.println("----- значение передаваемых параметров: а=-21");
        System.out.println("      >> Результат:"+isNegative(-21));
        System.out.println("----- значение передаваемых параметров: а=45");
        System.out.println("      >> Результат:"+isNegative(45));

        //Задание №7 "Написать метод, которому в качестве параметра передается строка, обозначающая имя.
        // Метод должен вывести в консоль сообщение «Привет, указанное_имя!»"
        System.out.println("\nПункт №7 Домашнего задания выполнен! Метод, выводящий в консоль приветственное сообщение подставляя в качестве имени входной параметр, создан.");
        System.out.println("Проверка работоспособности метода 'sayMeHi':");
        System.out.println("----- значение передаваемых параметров: name='Димоон'. Метод в точку вызова значений не возвращает, вызывается отдельно");
        sayMeHi("Димоон!!");
        System.out.println("----- значение передаваемых параметров: name='Володя'. Метод в точку вызова значений не возвращает, вызывается отдельно");
        sayMeHi("Володя..");

        // Задание№8 "Написать метод, который определяет, является ли год високосным, и выводит сообщение в консоль..."
        System.out.println("\nПункт №8 Домашнего задания выполнен! Метод, выводящий в консоль результат определения, является ли год високосным или нет, создан");
        System.out.println("Проверка работоспособности метода 'isLeapYear':");
        System.out.println("----- значение передаваемых параметров: year = 124. Метод в точку вызова значений не возвращает, вызывается отдельно");
        isLeapYear(124);
        System.out.println("----- значение передаваемых параметров: year = 1900. Метод в точку вызова значений не возвращает, вызывается отдельно");
        isLeapYear(1900);
        System.out.println("----- значение передаваемых параметров: year = 2000. Метод в точку вызова значений не возвращает, вызывается отдельно");
        isLeapYear(2000);
        System.out.println("----- значение передаваемых параметров: year = 2100. Метод в точку вызова значений не возвращает, вызывается отдельно");
        isLeapYear(2100);
    ...
    //задание №5 Метод определяет положительное число или нет и
    // выводит сообщение о результате в консоль.
    public static void sendMyIsPositiveOrNegativeNumber(int a) {
    ...
    //Задание №6
    // метод не только определяет положительное число или нет
    // но и возвращает булево значение результата
    ...
    //Задание №7
    // Метод "здоровается с пользователем"
    public static void sayMeHi(String name) {

        System.out.println("      Привет, "+ name +"!");
    }

    // Задание №8
    // Метод определяет високосный год или нет и выводит сообщение в консоль.
